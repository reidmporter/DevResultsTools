...
4. Open a new elevated/administor command line interface (CLI) prompt that supports using of PowerShell commands (for instance, right click the Powershell icon and choose "Run as administrator." If you don't have PowerShell installed you can follow instructions at [Installing Power Shell](https://docs.microsoft.com/en-us/powershell/scripting/install/installing-powershell?view=powershell-7.1).
...
- exportFilePath: Path (or just file name, if same directory) to create a folder for the exported files, e.g. `C:\Users\MyUser\InstanceExport\2021_Export\`
